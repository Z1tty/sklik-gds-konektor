...
var GROUP_ATTRS = [
  ...
  'conversionIds.clickMoney', 'conversionIds.conversionId', 'conversionIds.name', 'conversionIds.semEventName'
];
...
function expandGroupConversions(group) {
  ...
  convList.forEach(function(conv) {
    var convRow = {
      ...
      gof_groupStatus:         group.status || '',
      gof_groupIsDeleted:      group.isDeleted ? 'true' : 'false',
      gof_convId:             conv.conversionId    || 0,
      ...
      gof_clickMoney_kc:      (conv.clickMoney      || 0) * 0.01,
      gof_convTotalMoney_kc:  (conv.totalMoney      || 0) * 0.01,
