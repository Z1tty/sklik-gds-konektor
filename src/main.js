...
function getData(request) {
  ...
  DataStudioApp.createCommunityConnector()
    .newUserError()
    .setText('Nepodařilo se načíst data. Zkontrolujte prosím nastavení konektoru.')
    .setDebugText('getData: Ro.load() returned falsy without throwing')
    .throwException();
}
